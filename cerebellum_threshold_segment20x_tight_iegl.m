function layer = cerebellum_threshold_segment20x_tight_iegl(file, varargin)  
...
T = adaptthresh(mat2gray(a_set_thresh_egl), 0.15,'NeighborhoodSize' , 2*floor(size(a_nfg)/25)+1);
