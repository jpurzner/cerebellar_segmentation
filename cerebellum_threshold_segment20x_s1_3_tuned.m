function layer = cerebellum_threshold_segment20x_s1_3_tuned(file, varargin)  
...
% take 30% of cerebellum   (TUNED s1_3: 0.4 -> 0.55, looser to catch upper-region IGL)
c_bin = thresh_by_area( c_norm, all_cerebellum, 0.55 );
...
% TUNED s1_3: 200000 -> 50000 to keep smaller upper-region IGL pieces
c_final = bwareafilt(c_final > 0,[50000 Inf]);
