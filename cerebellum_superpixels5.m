function layer = cerebellum_superpixels5(file)  
...
pia_line = pia_line > 0.4; 
pia_line = bwareafilt(pia_line > 0,[30 Inf]);
...
pia_inner = ~ismember(pia_inner_bwl , unique((a_norm > 0.2 | c_mask ) .* pia_inner_bwl));
pia_inner_fill = filledgegaps(pia_inner, 21);
