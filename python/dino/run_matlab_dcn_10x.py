...
Uses cerebellum_threshold_segment2_with_dcn (the 10x sibling of
...
Output:
  /python/matlab_dcn_10x/<slide>_with_dcn.png
  /python/matlab_dcn_10x/_INDEX.png
  /python/matlab_dcn_10x/<slide>_dcn.log
"""
...
OUT = ROOT.parent / "matlab_dcn_10x"
...
t0 = tic;
try
    layer = cerebellum_threshold_segment2_with_dcn(img);
    fprintf('OK in %.1fs\\n', toc(t0));
catch ME
    fprintf('FAIL: %s\\n', ME.message);
